"""
Django settings for silent_disk_dev_60138 project.
...
ROOT_URLCONF = 'silent_disk_dev_60138.urls'
...
WSGI_APPLICATION = 'silent_disk_dev_60138.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_disk_dev_60138 API",
    "DESCRIPTION": "API documentation for silent_disk_dev_60138 App",
    "VERSION": "v1",
}
